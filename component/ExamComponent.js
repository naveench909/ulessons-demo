...
function ExamComponent({examObj}) {
    ...
    return (
        <ExamComponentStyles onClick={redirectToExamDetails}>
                <div className='first'>
                    <div className="first_child" onClick={e => e.stopPropagation()}>
                    ...
                    <div className='second_child' onClick={e => e.stopPropagation()}>
                        <div className="exam_class">{examObj.grade.grade_code}</div>
                        {!examObj.isRegisterd ? 
                            moment(examObj.registration_close_time).diff(moment(new Date()) , 'h') <= examObj.registration_close_warning_duration ? 
                ...
                <div className='second' onClick={e => e.stopPropagation()}>
                    {examObj.description}
                </div>
                <div className='third'>
                    <div className='exam_date' >
                        ...
                        <div className='calendar_date' onClick={e => e.stopPropagation()}>
                            {moment(examObj.start_time).format('Do MMMM')}
                        </div>
                    </div>
                    <div className='exam_totalQues'>
                        <div className="question_icon" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="question_content" onClick={e => e.stopPropagation()}>
                            {examObj.questions.length} questions
                        </div>
                    </div>
                    <div className='exam_time' >
                        <div className="timer" onClick={e => e.stopPropagation()}>
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="timer_content" onClick={e => e.stopPropagation()}>
                            {moment(examObj.start_time).format('h:mm a')}
                        </div>
                    </div>
                    <div className='exam_totalStudents'>
                        <div className="students" onClick={e => e.stopPropagation()}>
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="students_content" onClick={e => e.stopPropagation()}>{examObj.applicant_count} students</div>
                    </div>
                </div>
