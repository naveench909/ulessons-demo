            ...
            <div className='first'>
                <div className="first_child">
                    <div className='exam_image'>
                        {examObj.exam_title === "MATHEMATICS" ? 
                    ...
                    <div className='exam_title'>{examObj.exam_title}</div>
                </div>
                <div className='second_child'>
                    <div className="exam_class">{examObj.exam_class}</div>
                    {!examObj.isRegisterd ? 
            ...
            <div className='third'>
                ...
                <div className='exam_totalQues'>
                    ...
                    <div className="question_content">
                        {examObj.exam_questionList.length} questions
                    </div>
                </div>
                ...
                <div className='exam_totalStudents'>
                    ...
                    <div className="students_content">{examObj.total_students} students</div>
                </div>
            </div>
            <div className={examObj.isRegisterd ? `fourth registerdBtn` : "fourth"} >
