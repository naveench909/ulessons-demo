...
import style from '../styles/ExamSummaryExamCard.module.css'
import moment from 'moment';

function ExamSummaryExamCard({examObj}) {
    return (
        <div className={style.container}>
            <div className={style.first}>
                <div className={style.first_child}>
                    <div className={style.exam_image}>
                        {examObj.title === "Mathematics" ? 
                        (<svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15.1939 8.63915C15.7977 3.19578 9.07574 -0.76239 3.9647 1.1325C0.048842 2.80168 -0.132413 9.11824 3.23002 12.5278C6.72059 16.048 14.7032 13.1368 15.1939 8.63915Z" fill="#B0B2B7"/>
                            <g opacity="0.7">
                        ...
                        (
                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.22 8.28746C14.7851 3.06562 8.49397 -0.731455 3.71052 1.08631C0.0456542 2.68757 -0.123983 8.74706 3.02293 12.0178C6.28977 15.3948 13.7608 12.6021 14.22 8.28746Z" fill="#B0B2B7"/>
                                <g opacity="0.6">
                    ...
                    <div className={style.exam_title}>{examObj.title}</div>
                </div>
                <div className={style.second_child}>
                    <div className={style.exam_class}>{examObj.grade.grade_code}</div>
                </div>
            </div>
...
export default ExamSummaryExamCard;
